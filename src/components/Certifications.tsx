...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className={`${isDark ? 'bg-[#0D1117]' : 'bg-white'} py-12 px-6`}>
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`${isDark ? 'bg-[#161B22] border-[#30363D] hover:border-[#3B82F6]/50' : 'bg-gray-50 border-gray-200 hover:border-[#3B82F6]/50'} rounded-xl p-6 border transition-all duration-300`}
                >
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div>
                      <h4 className={`text-2xl font-semibold ${isDark ? 'text-[#E6EDF3]' : 'text-gray-900'} mb-2`}>{edu.degree}</h4>
                      <p className="text-[#3B82F6] font-medium text-base mb-2">{edu.institution}</p>
                      <p className={`${isDark ? 'text-[#E6EDF3]/80' : 'text-gray-700'} text-sm`}>{edu.year}</p>
                    </div>
                    <div className="mt-4 lg:mt-0 lg:text-right">
                      <div className={`inline-flex items-center gap-2 ${isDark ? 'bg-[#3B82F6]/10 text-[#3B82F6] border-[#3B82F6]/20' : 'bg-blue-50 text-blue-700 border-blue-200'} px-3 py-1.5 rounded-full border mb-4 text-sm`}>
            ...
            >
              {certifications.map((cert, index) => (
                <motion.div
                  ...
                  className={`${isDark ? 'bg-[#161B22] border-[#30363D] hover:border-[#3B82F6]/50 hover:shadow-[#3B82F6]/10' : 'bg-gray-50 border-gray-200 hover:border-[#3B82F6]/50 hover:shadow-blue-100'} rounded-xl p-6 border transition-all duration-300 group hover:shadow-xl flex flex-col`}
                >
