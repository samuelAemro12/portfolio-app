...
const OpenSource = () => {
  ...
  return (
    <section id="opensource" className={`${isDark ? 'bg-[#0D1117]' : 'bg-white'} py-12 px-6`}>
              ...
              >
                <div className="mb-4">
                  ...
                  {'prNumber' in contribution && contribution.prNumber && (
                    <span className="text-blue-400 text-sm">PR {contribution.prNumber}</span>
                  )}
                </div>
                ...
                <div className="space-y-3 mb-4">
                  <div>
                    <span className={`text-xs font-medium ${isDark ? 'text-[#E6EDF3]/70' : 'text-gray-600'} uppercase tracking-wide`}>Role</span>
                    <p className={`text-sm ${isDark ? 'text-[#E6EDF3]' : 'text-gray-900'} font-medium`}>{contribution.role}</p>
                  </div>
                  <div>
                    <span className={`text-xs font-medium ${isDark ? 'text-[#E6EDF3]/70' : 'text-gray-600'} uppercase tracking-wide`}>Impact</span>
                    <p className={`text-sm ${isDark ? 'text-[#E6EDF3]' : 'text-gray-900'}`}>{contribution.impact}</p>
                  </div>
                </div>
